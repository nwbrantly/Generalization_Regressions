...
for i=1:28
    if i<15
    Li{1}=scatter(nanmean(TM(1,481:485,i)),nanmean(OG(1,481:485,i)),100,"filled",'MarkerFaceColor', 'b');
    text(nanmean(TM(1,481:485,i)),nanmean(OG(1,481:485,i)),{labels(i).Data(2:end-1)})
    else
      Li{2}=scatter(nanmean(TM(1,481:485,i)),nanmean(OG(1,481:485,i)),100,"filled",'MarkerFaceColor', 'r')  ;
        text(nanmean(TM(1,481:485,i)),nanmean(OG(1,481:485,i)),{labels(i).Data(2:end-1)})
    end
...
for i=1:28
    if i<15
    Li{1}=scatter(nanmean(TM(2,481:485,i)),nanmean(OG(2,481:485,i)),100,"filled",'MarkerFaceColor', 'b');
    text(nanmean(TM(2,481:485,i)),nanmean(OG(2,481:485,i)),{labels(i).Data(2:end-1)})
    else
      Li{2}=scatter(nanmean(TM(2,481:485,i)),nanmean(OG(2,481:485,i)),100,"filled",'MarkerFaceColor', 'r')  ;
        text(nanmean(TM(2,481:485,i)),nanmean(OG(2,481:485,i)),{labels(i).Data(2:end-1)})
    end
