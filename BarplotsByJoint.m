...
for l=1:length(muscle)
    ...
    if muscle(l)<=3 %'sHIP= [reacrive contextual muscle_number subject]
        ...
        if isempty(ship)==1
            ship(1,:)=[mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
            
        else
            ship(end+1,:)=[ mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        end
        
    elseif muscle(l)>=4 &&  muscle(l)<=9 %sTHIGH = [reacrive contextual muscle_number subject]
        
        if isempty(sknee)==1
            sknee(1,:)=[mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        else
            sknee(end+1,:)=[mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        end
    ...
    elseif muscle(l)>=10 &&  muscle(l)<=14 %sSHANK = [reacrive contextual muscle_number subject]'
        ...
        if isempty(sank)==1
            sank(1,:)=[mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        else
            sank(end+1,:)=[mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        end
    ...
    elseif muscle(l)>=15 &&  muscle(l)<=17 %fHIP = [reacrive contextual muscle_number subject]'
        if isempty(fhip)==1
            ...
            fhip(1,:)=[mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        else
            fhip(end+1,:)=[ mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        end
        
        
    elseif muscle(l)>=18 &&  muscle(l)<=23 %fTHIGH = [reacrive contextual muscle_number subject]'
        if isempty(fknee)==1
            fknee(1,:)=[mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        else
            fknee(end+1,:)=[mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        end
        
    elseif muscle(l)>=24 %fSHANK = [reacrive contextual muscle_number subject]'
        if isempty(fank)==1
            fank(1,:)=[mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        else
            fank(end+1,:)=[mean(reactive_trace(41:45,muscle(l),subj(l)),'omitnan') mean(contextual_trace(41:45,muscle(l),subj(l)),'omitnan') muscle(l) subj(l)];
        end
